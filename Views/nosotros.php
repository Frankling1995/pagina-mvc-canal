<?php include_once 'Views/include/links.php';?>
    ...
    <!------------------------------------------------>
        <div class="container">
        <section class="noticia py-5 mt-4">    
            <h2 class="text-center text-uppercase " ><span >Nosotros</span></h2>
        </section>
            <div class="row">
                <div class="col-md-6">
                    <h3 class="text-center text-uppercase " ><span >Trabajamos para ti </span></h3>
                    <article class="justify-content mt-4">
                    <p class="text-justify text-lowercase">
                        Desarrollaremos un sistema modelo vista controlador básico, justo para entender 
                        ¿Cómo funciona este patrón de diseño de arquitectura de Software?Pero antes. El MVC separa tres aspectos 
                        ¿Cómo funciona este patrón de diseño de arquitectura de Software?Pero antes. El MVC separa tres aspectos 
                        <br>
                        ¿Cómo funciona este patrón de diseño de arquitectura de Software?Pero antes. El MVC separa tres aspectos
                        ¿Cómo funciona este patrón de diseño de arquitectura de Software?Pero antes. El MVC separa tres aspectos 
                ...
                <div class="col-md-6">
                    <div class="img-nosotros">
                        <img class="img-fluid" src="<?php echo BASE_URL;?>Views/assets/img/nosotros.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
